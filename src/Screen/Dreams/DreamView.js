...
import {deleteDreamData, deleteGoalByDate, deleteJournalData, deleteTaskById, updateAllGoalData} from '../../redux/actions';
...
const DreamView = ({route, navigation}) => {
  ...
  }, [currentDate, getDreamData, dispatch, goalData]);
